...
class CampsiteInfo extends Component {
    ...
    render() {
        ...
        return (
            <ScrollView>
                <RenderCampsite onShowModal={() => this.toggleModal()} campsite={campsite} favorite={ this.props.favorites.includes(campsiteId) }
                ...
                <Modal animationType={'slide'} transparent={false} visible={this.state.showModal} onRequestClose={() => this.toggleModal()}>
                    <View style={styles.modal}>
                            <Rating
                                ...
                                onFinishingRating={rating => this.setState({rating: rating})}
                            />
                            <Input
                                placeholder= "author"
